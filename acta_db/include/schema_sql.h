/* GENERATED FILE - do not edit by hand. Source of truth: acta_db/schema.sql.
 * Regenerated by the acta_db Makefile rule (schema_sql.h: schema.sql).
 * Embedded as one C string literal: each line is a quoted literal ending in an
 * escaped newline. The schema contains no double-quote or backslash
 * characters, so no other escaping is needed. */

#ifndef ACTA_SCHEMA_SQL_H
#define ACTA_SCHEMA_SQL_H

static const char ACTA_SCHEMA_SQL[] =
