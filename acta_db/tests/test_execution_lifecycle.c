...
static void test_exec_query_any_returns_all(void) {
    ...
    int n = 0, err = 0;
    execution_t **items =
        acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY, 0, 0, &n, &err);
...
static void test_exec_query_limit_caps(void) {
    ...
    int n = 0, err = 0;
    execution_t **items =
        acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY, 0, 4, &n, &err);
    TEST_ASSERT_EQ_INT(err, ACTA_DB_OK);
...
static void test_exec_query_offset_skips(void) {
    ...
    int n = 0, err = 0;
    execution_t **items =
        acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY, 2, 2, &n, &err);
    TEST_ASSERT_EQ_INT(err, ACTA_DB_OK);
...
static void test_exec_query_offset_exhausted(void) {
    ...
    int n = -1, err = 0;
    execution_t **items =
        acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY, 50, 10,
                                &n, &err);
    TEST_ASSERT_EQ_INT(err, ACTA_DB_OK);
...
static void test_exec_query_negative_offset(void) {
    ...
    int n = 0, err = 0;
    execution_t **items =
        acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY, -1, 10,
                                &n, &err);
...
static void test_exec_query_null_db(void) {
    int n = 0, err = 0;
    execution_t **items =
        acta_db_execution_query(NULL, &ACTA_EXEC_QUERY_ANY, 0, 0,
                                &n, &err);
    TEST_ASSERT_EQ_INT(err, ACTA_DB_ERR_INVALID);
    TEST_ASSERT(items == NULL);
}
...
static void test_exec_count_all(void) {
    ...
    int err = 0;
    TEST_ASSERT_EQ_INT(
        acta_db_execution_count(e.db, &ACTA_EXEC_QUERY_ANY, &err), 7);
    env_close(&e);
}
...
static void test_exec_query_pagination_loop(void) {
    ...
    for (int offset = 0; offset < total; offset += page_size) {
        int n = 0;
        execution_t **items =
            acta_db_execution_query(e.db, &ACTA_EXEC_QUERY_ANY,
