...
static void test_list_default_excludes_deleted(stest_ctx_t *ctx)
{
    ...
    char *argv0[] = { "actagamma_db", "skill", "list" };
    ...
    char *argv1[] = { "actagamma_db", "skill", "list", "--all" };
...
static void test_list_include_deleted(stest_ctx_t *ctx)
{
    ...
    char *argv0[] = { "actagamma_db", "skill", "list", "--all",
                      "--include_deleted" };
...
static void test_list_folder_include_deleted(stest_ctx_t *ctx)
{
    ...
    char *argv1[] = { "actagamma_db", "skill", "list",
                      "--folder_id", "2" };
...
static void test_get_deleted_alias(stest_ctx_t *ctx)
{
    ...
    char *argv0[] = { "actagamma_db", "skill", "get", "5" };
    int rc = stest_run_argv(ctx, cmd_skill, 4, argv0, "");
    TEST(ctx, rc != EXIT_OK);

    /* With the alias: the row comes back */
    char *argv1[] = { "actagamma_db", "skill", "get", "5", "--deleted" };
    rc = stest_run_argv(ctx, cmd_skill, 5, argv1, "");
    TEST_EQ(ctx, rc, EXIT_OK);
...
{
    char *argv0[] = { "actagamma_db", "skill", "list", "--deletd" };
    int rc = stest_run_argv(ctx, cmd_skill, 4, argv0, "");
...
static void test_unknown_flag_typo_close_to_real(stest_ctx_t *ctx)
{
     ...
     * filter. */
    char *argv0[] = { "actagamma_db", "skill", "list", "--include_delete" };
    int rc = stest_run_argv(ctx, cmd_skill, 4, argv0, "");
    TEST_EQ(ctx, rc, EXIT_INVALID);
}
...
{
    char *argv0[] = { "actagamma_db", "skill", "list", "--no_such_opt=1" };
    int rc = stest_run_argv(ctx, cmd_skill, 4, argv0, "");
    TEST_EQ(ctx, rc, EXIT_INVALID);
}
