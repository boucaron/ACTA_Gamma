...
void help_print(FILE *out)
{
    fprintf(out,
        ...
        "                     platform app-data location — the same file the\n"
        "                     GUI uses: %%APPDATA\\ACTA Gamma\\acta.db\n"
        "                     (Windows), ~/.local/share/ACTA Gamma/acta.db\n"
        "                     (Linux); ./acta.db only as a last resort)\n"
